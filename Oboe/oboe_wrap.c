...
SWIGEXPORT void SWIGSTDCALL CSharp_oboe_set(void * jarg1) {
  namespace arg1 ;
  namespace *argp1 ;
...
SWIGEXPORT void * SWIGSTDCALL CSharp_oboe_get() {
  void * jresult ;
  namespace result;
...
SWIGEXPORT int SWIGSTDCALL CSharp_OBOE_VERSION_MAJOR_get() {
  int jresult ;
  int result;
...
SWIGEXPORT int SWIGSTDCALL CSharp_OBOE_VERSION_MINOR_get() {
  int jresult ;
  int result;
...
SWIGEXPORT int SWIGSTDCALL CSharp_OBOE_VERSION_PATCH_get() {
  int jresult ;
  int result;
...
SWIGEXPORT int SWIGSTDCALL CSharp_OBOE_VERSION_NUMBER_get() {
  int jresult ;
  int result;
